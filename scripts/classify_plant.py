...
# Load models
plant_detector = joblib.load('models/is_plant_classifier.pkl')
plant_classifier = joblib.load('models/plant_recognition_rf_model_updated.pkl')
...
def classify_plant(image_path):
    ...
    try:
        ...
        # Stage 1: Check if it's a plant
        is_plant = plant_detector.predict(features)[0]
        if is_plant != 'plant':
            return None, {"info": "This is not a plant image."}

        # Stage 2: Predict the type of plant
